  ...
  return (
    <section className="w-100 bg-black p-5 border-t-[10px] border-[rgb(35,35,35)]">
      <div className="max-w-[1170px] mx-auto mt-[5%]">
        <h1 className="text-white text-center font-black mb-[38px] lg:text-5xl text-[32px]">
        ...
        {faqData.map((faq, index) => (
          <div key={index} className="faqitems">
            <h4
              className="sm:text-2xl text-[16px] flex items-center justify-between"
              onClick={() => handelClick(index)}
            >
              {faq.title}{" "}
              {isOpen[index] ? (
                <FontAwesomeIcon icon={faMinus} className="ml-auto" />
              ) : (
                <FontAwesomeIcon icon={faPlus} className="ml-auto" />
              )}
            </h4>
            <p
              style={{
        ...
        <div className="mx-auto my-[30px] text-center">
          <p className="text-white mb-[20px] sm:text-[22px] text-[15px]">
